...
- [ ] **Step 1: Add RED tests for the closed transcript schema**
...
- [ ] **Step 3: Implement only the pure closed validators**
...
- [ ] **Step 2: Add RED stage-provenance tests**
...
- [ ] **Step 3: Verify RED, then implement minimal readiness/provenance behavior**
...
- [ ] **Step 1: Add RED ordering and independent-leg tests**
...
- [ ] **Step 2: Add RED zero-byte and malformed-byte tests**
...
- [ ] **Step 3: Verify RED, then implement the source-freeze state machine**
...
- [ ] **Step 1: Add RED removal and recovery tests**
...
- [ ] **Step 2: Add RED ambiguity tests**
...
- [ ] **Step 3: Verify RED, then integrate inventory-based recovery**
...
- [ ] **Step 2: Resolve every spec issue test-first and re-review**

No Critical or Important issue may remain.

- [ ] **Step 3: Run code-quality and security-boundary review**
...
- [ ] **Step 4: Run fresh static verification**
...
observation surface rather than evidence authority.

- [ ] **Step 4: Commit the result references and public bundle**

Commit with an exact run ID and implementation commit in the progress record.
