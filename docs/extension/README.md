...
This area will hold a compatibility matrix and a proposal limited to semantics
needed for continuously recomputed authority at a transport boundary that are
not already specified by KTP v2.0.0.
