...
| 4 — decision engine | expected RED: missing `kil.engine` module, exit 1; runtime contract regressions then exposed 2 failures and 3 errors | bundled Python 3.12; focused suite 14 tests and full validation 56 tests passed, 0 failed; source checksums and `git diff --check` passed | pending | pending | awaiting review |
